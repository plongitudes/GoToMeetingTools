...
## Usage Summary
- go add <lt;descriptor>rt; <lt;goto line #>rt;
- go join <lt;search pattern>rt;
- go update <lt;search pattern>rt;
- go delete <lt;search pattern>rt;
- go backup
- go restore
- go import <lt;filename>rt;
